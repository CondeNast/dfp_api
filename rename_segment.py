...
def main(client, oldname, newname):
  ...
  statement = (ad_manager.StatementBuilder(version='v201902')
               .Where('Type = :type AND Name = :audience_segment_name')
               .WithBindVariable('audience_segment_name', oldname)
...
if __name__ == '__main__':
  ...
  if (numargs in [3]):
    ...
    main(ad_manager_client, *sys.argv[1:])
  else:  
    print 'Usage: rename_segment oldname newname'
