...
def main(client, name, custom_targeting_key_id=None, custom_targeting_value_id=None):
  ...
  if (custom_targeting_value_id): 
    ...
    # No custom taregeting criteria, so use only inventory rule
    rule = {
        'inventoryRule': inventory_targeting
    }  
